...
public class C04_HandleAlerts {
    ...
    */
    ...
    public void alertTest() throws InterruptedException {
        ...
        /*
        youtube 'daki kutular html alerttir ve ınspect edilirler fakat bazı alerler ınspect edilmez
         */
    ...
    public void dismissalertTest() throws InterruptedException {
        ...
        driver.switchTo().alert().dismiss(); // cancel dedigi icin soruda .dismiss() aldik
        Thread.sleep(2000);
    ...
    public void sendKeysTesti() throws InterruptedException {
        driver.get("https://the-internet.herokuapp.com/javascript_alerts");//bagımsız calısması icin her seferinde ayrı ayrı adresi yazdık
        ...
        driver.switchTo().alert().sendKeys("Nese Ozer");
        Thread.sleep(3000);
